...
def main():
    ...
    cv2.imwrite('D:\\Network model file\\code\\beauty\\3finish_content-aware-rotation-master\\GAMA\img\\output\\output.jpg', dstimg)
    cv2.waitKey(0)

    return 0


input_fn = 'D:\\Network model file\\code\\beauty\\3finish_content-aware-rotation-master\\GAMA\\img\\input\\test2.png'
