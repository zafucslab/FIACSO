...
if __name__ == '__main__':
    ...
    img = cv2.imread("D:\\Network model file\\code\\beauty\\3finish_content-aware-rotation-master\\GAMA\\img\\input\\processed_image.jpg")
    ...
    # cv2.imwrite("D:\\Network model file\\code\\beauty\\3finish_content-aware-rotation-master\\GAMA\\img\\fin\\output.jpeg", img2)
    cv2.waitKey(0)